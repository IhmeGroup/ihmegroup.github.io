...
Fetches all works for ORCID 0000-0002-4158-7050 and writes a clean papers.bib.
...
CONTACT_EMAIL = "jjhans@stanford.edu"
...
# To find new ones: https://openalex.org/authors?filter=display_name:Matthias+Ihme
EXTRA_AUTHOR_IDS = [
    "A5128781238",
    "A5127391153",
    "A5126644706",
...
def _fetch_works_by_filter(filter_str: str, label: str = '') -> list:
    ...
    results = []
    cursor = '*'
    headers = {'User-Agent': f'ihmegroup-website/1.0 (mailto:{CONTACT_EMAIL})'}
